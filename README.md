...
After cloning repository, be sure to install the required dependencies by running the following commands
* npm install
* npm install node-sass

Once all required dependencies are installed, run npm start to start the application on http://localhost:3000/
